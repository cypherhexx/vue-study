...
const store = new Vuex.Store({
    ...
    mutations: {
        ...
        [types.MUSIC_SONG_CHANGE](state, payload) {
            // state.music.activeSong.activeSrc = payload.activeSrc;  资源失效，使用新资源地址播放
            state.music.activeSong.activeSrc = `https://music.163.com/song/media/outer/url?id=${payload.id}.mp3`;
