...
<style lang="scss" scoped>
	...
	.md-theme-blue a:not(.md-button),
	.md-theme-blue .soucecode {
		color: #2196f3
	}
	.md-theme-teal a:not(.md-button),
	.md-theme-teal .soucecode {
		color: #009688
	}
	.md-theme-brown a:not(.md-button),
	.md-theme-brown .soucecode {
		color: #795548
	}
	.md-theme-indigo a:not(.md-button),
	.md-theme-indigo .soucecode {
		color: #3f51b5
	}
</style>