	...
	<div id="login" @keyup.enter="login">
		<transition name="slideT">
			<div class="login-tip" v-show="tipFlag">
				test：&nbsp&nbspGo：test &nbsp&nbsp&nbsp test：test
			</div>
		</transition>
		<form novalidate autocomplete="off">
			...
			<md-input-container md-theme="whiteForm">
				<md-icon>
					...
					<md-tooltip>Go</md-tooltip>
				</md-icon>
				<label></label>
				<md-input type="password" v-model="password" :required='inputFlag'></md-input>
				<md-icon></md-icon>
			</md-input-container>
			<md-button class="md-raised md-accent" md-theme="whiteForm" @click="login">Save</md-button>
			<md-button class="md-raised md-warn" md-theme="whiteForm" @click="goRegist">Cancel</md-button>
		</form>
